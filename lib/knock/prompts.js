...
- Limits: skills max 14 (tools and hard skills only, no soft skills), quantifiedWins max 6 (achievements that contain a number), experience max 5 entries most recent first with max 3 bullets each.
