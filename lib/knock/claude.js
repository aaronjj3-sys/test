...
export async function claudeJSON({ system, prompt, content, schema, maxTokens = 2000 }) {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: content
              ? [
                ...content,
                { type: "text", text: `Return only valid JSON matching this JSON schema:\n${JSON.stringify(schema)}` },
              ]
  ...
  properties: {
    ...
    sections: {
      ...
      items: {
        ...
        additionalProperties: false,
        properties: {
          title: { type: "string", description: "Original resume section title, e.g. Education, Professional Experience, Leadership, Projects" },
          items: {
            type: "array",
            items: {
              type: "object",
      ...
      description: "Preserve meaningful resume sections in their original order, max 8 sections",
    },
    experience: {
      type: "array",
      items: {
      ...
      description: "Professional/work items most recent first, max 6",
    },
    extraContext: { type: "string", description: "One or two sentences of notable context: clubs, projects, interests" },
  },
